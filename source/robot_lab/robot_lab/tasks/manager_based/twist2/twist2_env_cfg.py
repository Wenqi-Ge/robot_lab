"""
@File: twist2_env_cfg.py
@Author: Winky GE
@Date: 2026-01-04
@Brief: Twist2 environment configuration
"""
...
@configclass
class Twist2EnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the Twist2 environment."""
    ...
    def __post_init__(self):
        ...
        # Motion command configuration (需要在子类中设置具体值)
        # self.commands.motion.motion_file = "path/to/motion.npz"
        # self.commands.motion.anchor_body_name = "torso_link"
        # self.commands.motion.body_names = ["pelvis", "left_hip_roll_link", ...]
